...
export default function DestinationImage({ data }) {
  return (
    <Container className="flex flex-col md:justify-start md:items-start items-center justify-center  py-8 px-4">
      ...
      {/* Informations */}
      <div className="flex flex-col items-start justify-start gap-6 px-8 md:px-4 py-8 w-screen max-w-4xl">
